    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-between justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-between mb-md-0">
          <li><a href="#" class="nav-link px-2 link-secondary">概要</a></li>
          <li><a href="#" class="nav-link px-2 link-white">在庫</a></li>
          <li><a href="#" class="nav-link px-2 link-dark">顧客</a></li>
          <li><a href="#" class="nav-link px-2 link-dark">製品</a></li>
        </ul>

        <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
          <input type="search" class="form-control" placeholder="検索...">
        </form>
